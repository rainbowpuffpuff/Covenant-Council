...
export const principles: Principle[] = [
  {
    ...
    assessmentCriteria: [
        'Inherence: Does the submission treat personhood as an inherent right, or does it create a system where personhood can be "issued" or "revoked" by a central entity?',
        'Gatekeepers: Does this submission dismantle existing gatekeepers (institutions, corporations, governments) or does it create new ones? Analyze the dependencies required for a user to prove their personhood.',
        'Access: Does this system allow every individual to prove their personhood, or does it (intentionally or not) exclude people based on access to specific hardware, data, or credentials?',
        'Self-Determination: Does this submission enhance a user\'s self-determination, creative expression, and self-governance as a direct result of its personhood model?',
    ],
  },
  {
    id: 2,
    ...
    assessmentCriteria: [
        'Key Custody: Does this system grant the user direct and exclusive control of their cryptographic keys? Does it default to self-custody?',
        'Authority: Does the system create any authority (a company, a network, a protocol) that can "grant" or "revoke" access to these keys, or does it treat ownership as "self-evident"?',
        'Resilience: How does the submission address key management? Analyze its mechanisms for recoverability (is it user-controlled?), persistence (can the keys be lost forever?), and security (does it mention future threats, like quantum?).',
        'Sovereignty: Does the submission\'s architecture ensure that because the user controls their keys, their other digital rights (to assets, data, identity) "cannot be taken away"?',
    ],
  },
  {
    id: 3,
    ...
    assessmentCriteria: [
        'Default State: Is the system\'s default setting "private" (opt-in to share) or "public" (opt-out to hide)? Analyze what data, if any, is viewable by default.',
        'Consent Model: How is "explicit consent" managed? Is it granular? Is it a one-time, all-or-nothing agreement, or can the user consent to specific data uses?',
        'Data Visibility: Does the architecture prevent service providers (including the system\'s creators) from viewing personal data? Look for the use of end-to-end encryption, zero-knowledge proofs, or other privacy-preserving techniques.',
        'Agency: Does the submission identify ways data could be used to "undermine agency" (e.g., manipulation, predictive targeting) and does it provide specific technical safeguards against this?',
    ],
  },
  {
    id: 4,
    ...
    assessmentCriteria: [
        'Openness: Does the submission "safely open source" its code, content, documentation, and processes? Analyze the choice of license (e.g., MIT, GPL, Creative Commons) or the lack thereof.',
        'Data Networks: Does it promote "open data networks" or does it create a "walled garden" where data is siloed and proprietary?',
        'Exchange: Does the system\'s design facilitate the "open exchange of art, science, code, and ideas," or does it create barriers (e.g., paywalls, proprietary formats)?',
        'Advancement: Does this submission contribute to "human advancement" by building on and contributing back to the "collective imagination," or is it a purely extractive, proprietary work?',
    ],
  },
  {
    id: 5,
    ...
    assessmentCriteria: [
        'Permissionless Access: Does this submission promote a free flow of capital, or does it create new financial "gatekeepers" or intermediaries that can control, censor, or block access to financial tools?',
        'Equitable Systems: Does the system\'s design encourage equitable participation, or does its economic model favor early/wealthy participants and extract value from latecomers?',
        'Friction Reduction: Does this submission reduce friction for capital (e.g., cross-border, micro-payments, smart contracts) in a way that empowers individuals rather than just institutions?',
        'Open Finance: Is the system\'s financial layer open, transparent, and composable, allowing others to build upon it, or is it a closed, proprietary financial product?',
    ],
  },
  {
    id: 6,
    ...
    assessmentCriteria: [
        'Incentive Alignment: Analyze the incentive structure of the submission. Is it designed to channel capital toward public goods (open-source, scientific discovery, community well-being), or is it designed to extract private profit from them?',
        'Value Creation: Does the submission create "collective well-being" as a primary goal, or is collective well-being a secondary, "hopeful" byproduct of a profit-first model?',
        'Beneficiaries: Who are the primary financial beneficiaries of this system? Are they the "healthy communities of creative practice" or a small group of owners/investors?',
        'Mechanism: Does the submission propose or use a specific mechanism (e.g., quadratic funding, retroactive public goods funding) to make public goods the "greatest basins for capital flow"?',
    ],
  },
  {
    id: 7,
    ...
    assessmentCriteria: [
        'Empowerment: Does this submission put "robust cryptography and AI-enhanced defenses... in the hands of individuals," or does it centralize security, forcing the user to trust a third party?',
        'Threat Model: Does the submission demonstrate an awareness of threats like "key loss, surveillance, and intrusion"? How "robust" are its proposed defenses?',
        'User Agency: Does the system "help make safe choices" by heightening user "awareness," or does it make complex, opaque security decisions for the user?',
        'Freedom of Action: Does the security model enable the user to "act freely," or is it so restrictive, complex, or fragile that it hinders freedom?',
    ],
  },
  {
    id: 8,
    ...
    assessmentCriteria: [
        'The Balance: How does the submission balance individual privacy/freedom with "collective accountability"? Does it provide a strong rationale for this balance?',
        'Abuse Prevention: Does the system have mechanisms to prevent "bad actors from weaponizing privacy"?',
        'Social Contract: Does the system articulate a clear "social contract"? How do participants "freely enter" into it? What are the "clear standards" and "consequences for violations"?',
        'Consent: How is consent managed? Is it a one-time act, or is it an ongoing, voluntary process that "fosters cooperation"?',
    ],
  },
  {
    id: 9,
    ...
    assessmentCriteria: [
        'Intertwining: Does the submission acknowledge that the "digital realm and physical world are intertwined"? Does it account for its real-world resource consumption (e.g., energy, hardware, e-waste)?',
        'Definition of Progress: Does the submission define "progress" purely in technological terms, or does it factor in the "planet\'s ability to sustain diverse, flourishing life"?',
        'Externalities: Does the submission address its potential negative environmental externalities, or does it ignore them?',
        'Net Impact: Is the net effect of this submission positive for "Earth Public Goods," or is it a system that "undermines the planet" for a digital gain?',
    ],
  },
  {
    id: 10,
    ...
    assessmentCriteria: [
        'Capture Resistance: How does the submission\'s design "empower human agency"? How does it prevent the network from being "controlled or captured" by centralized "power" (e.g., corporations, states)?',
        'Fork-ability: Is the system truly "human-centric" and open? Does its design (e.g., open-source, decentralized infrastructure) ensure that "would-be oppressors" would be left "with little to gain" because participants could "fork" the system?',
        'Network Strength: Does the submission\'s design strengthen the "ties that bind" the community, or does it create dependencies that weaken the collective?',
        'Adaptability: Does the system have a mechanism to "adapt" and evolve over time to remain aligned with the Covenant\'s principles, even as external pressures change?',
    ],
  },
];
